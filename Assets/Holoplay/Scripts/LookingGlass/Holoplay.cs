...
namespace LookingGlass {
    ...
    public partial class Holoplay : MonoBehaviour {
        ...
        //public GameObject movieTexture = GameObject.Find("Quad");
        //publicHeadTrack headtrack = movieTexture.GetComponent<HeadTrack>();
        //public double x = headtrack.angle_y;
        //Debug.Log(x);
        ...
        public void RenderQuilt(bool forceRender = false) {
            ...
            //Debug.Log("HoloplayRendering.csへ");
            //Debug.Log(movieTexture.GetComponent<HeadTrack>());
            UpdateFinalCameraDepth();
